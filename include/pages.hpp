...
<!DOCTYPE html><html lang="pt-br"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Retificador controlado</title><style>body{width:100%;height:100vh;margin:0;padding:0;box-sizing:border-box;background-color:#73f3c8;font-family:"Segoe UI",Tahoma,Geneva,Verdana,sans-serif}header{display:flex;align-items:center;justify-content:space-between;padding:1rem}.ifal-logo{width:100%;max-width:13rem}main{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:2rem 1rem}.form{padding-top:1rem}input{width:11rem;padding:.3rem .5rem;outline:0;border-radius:.2rem;border:none}button{padding:.3rem .6rem;outline:0;border-radius:.2rem;border:none;background-color:#7fc1ff;cursor:pointer}.alert{display:none;margin-top:1rem;padding:.5rem;border-radius:.2rem;background-color:#e03737;color:#fff}.waves{display:flex;gap:5rem;padding-top:2rem}footer{padding-top:2rem;text-align:center}</style></head><body><header><svg version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2418.000000 847.000000" preserveAspectRatio="xMidYMid meet" class="ifal-logo"><g transform="translate(0.000000,847.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"><path d="M2194 6919 c-277 -31 -510 -251 -560 -529 -59 -329 143 -650 466
-739 91 -25 238 -28 325 -6 350 89 564 444 475 789 -81 318 -377 521 -706 485z"/><path d="M3143 6850 c-60 -36 -58 -20 -58 -572 0 -499 0 -507 21 -535 40 -53
31 -53 569 -53 538 0 529 0 569 53 21 28 21 36 21 537 0 501 0 509 -21 537
-40 53 -31 53 -569 53 -478 0 -501 -1 -532 -20z"/><path d="M4575 6860 c-11 -4 -31 -20 -45 -35 l-25 -27 0 -520 0 -520 37 -34
38 -34 505 0 c429 0 510 2 535 15 62 32 60 10 60 575 0 565 2 543 -60 575 -25
13 -104 15 -527 14 -274 0 -507 -4 -518 -9z"/><path d="M14450 5460 c-145 -17 -240 -61 -325 -151 -107 -112 -149 -242 -149
...
116 104 244 101 78 -2 98 -7 138 -30z"/><path d="M8620 5446 c-154 -45 -240 -148 -248 -301 -5 -104 19 -173 89 -249
...
-86 2 -145 -1 -175 -10z"/><path d="M6520 4850 l0 -600 125 0 125 0 0 600 0 600 -125 0 -125 0 0 -600z"/><path d="M7070 4850 l0 -600 116 0 117 0 -6 428 c-3 235 -9 437 -12 450 -21
...
-600z"/><path d="M9230 5345 l0 -105 160 0 160 0 0 -495 0 -495 130 0 130 0 0 495 0
495 160 0 160 0 0 105 0 105 -450 0 -450 0 0 -105z"/><path d="M10310 4850 l0 -600 130 0 130 0 -2 598 -3 597 -127 3 -128 3 0 -601z"/><path d="M10750 5345 l0 -105 160 0 160 0 0 -495 0 -495 130 0 130 0 0 495 0
495 160 0 160 0 0 105 0 105 -450 0 -450 0 0 -105z"/><path d="M11820 5053 c0 -228 5 -426 11 -463 27 -169 132 -285 304 -336 74
...
-203 30 -240 128 -15 39 -18 99 -22 458 l-4 412 -124 0 -124 0 0 -397z"/><path d="M12980 5345 l0 -105 160 0 160 0 0 -495 0 -495 125 0 125 0 2 493 3
492 163 3 163 2 -3 103 -3 102 -447 3 -448 2 0 -105z"/><path d="M15787 5443 c-4 -3 -7 -273 -7 -600 l0 -593 125 0 125 0 0 235 0 235
203 2 202 3 3 103 3 102 -206 0 -205 0 0 155 0 155 220 0 220 0 0 105 0 105
-338 0 c-186 0 -342 -3 -345 -7z"/><path d="M16700 4850 l0 -600 345 0 345 0 0 105 0 105 -220 0 -220 0 0 155 0
155 205 0 206 0 -3 103 -3 102 -202 3 -203 2 0 130 0 130 220 0 220 0 0 105 0
105 -345 0 -345 0 0 -600z"/><path d="M17638 5444 c-5 -4 -8 -275 -8 -602 l0 -594 253 5 c276 5 329 13 444
...
392 118 -4 c94 -4 128 -9 170 -28z"/><path d="M18870 4850 l0 -600 345 0 345 0 0 105 0 105 -220 0 -220 0 0 155 0
155 205 0 206 0 -3 103 -3 102 -202 3 -203 2 0 130 0 130 220 0 221 0 -3 103
-3 102 -342 3 -343 2 0 -600z"/><path d="M19800 4850 l0 -600 130 0 130 0 0 230 0 231 67 -3 66 -3 141 -227
...
-151 -212 -156 l-98 -4 0 162 0 163 94 -5 c68 -4 106 -11 139 -27z"/><path d="M22057 5443 c-4 -3 -7 -273 -7 -600 l0 -593 370 0 370 0 0 105 0 105
-240 0 -240 0 0 495 0 495 -123 0 c-68 0 -127 -3 -130 -7z"/><path d="M1738 5424 c-58 -31 -58 -27 -58 -574 0 -551 -1 -537 60 -574 25 -14
83 -16 530 -16 447 0 505 2 530 16 61 37 60 23 60 574 0 550 1 544 -60 575
-43 22 -1021 22 -1062 -1z"/><path d="M3151 5427 c-13 -6 -34 -25 -45 -40 -21 -28 -21 -36 -21 -535 0 -552
-2 -536 58 -572 31 -19 55 -20 532 -20 484 0 501 1 533 20 62 38 62 39 62 570
0 521 0 525 -55 568 -28 22 -30 22 -534 22 -382 0 -512 -3 -530 -13z"/><path d="M1764 4029 c-16 -5 -41 -20 -55 -35 l-24 -26 0 -523 0 -523 24 -26
c14 -14 41 -30 60 -36 48 -13 954 -13 1002 0 19 6 46 22 60 36 l24 26 0 523 0
523 -24 26 c-14 14 -41 30 -60 36 -45 12 -964 12 -1007 -1z"/><path d="M3173 4033 c-34 -7 -71 -47 -83 -92 -7 -28 -10 -192 -8 -518 3 -424
5 -481 20 -508 33 -61 22 -60 577 -60 466 0 508 1 532 18 55 37 54 29 54 572
0 543 1 535 -54 572 -24 17 -67 18 -521 19 -272 1 -505 0 -517 -3z"/><path d="M4581 4027 c-19 -7 -44 -25 -55 -40 -21 -28 -21 -36 -21 -542 0 -506
...
-12z"/><path d="M7430 3320 l0 -490 50 0 50 0 0 490 0 490 -50 0 -50 0 0 -490z"/><path d="M6867 3743 c-4 -6 -303 -773 -346 -885 l-11 -28 54 0 53 0 54 143 55
...
-160 75 -205z"/><path d="M7902 3521 c-65 -17 -122 -43 -122 -56 0 -18 21 -65 29 -65 4 0 32 9
...
l47 1 0 -47z"/><path d="M8564 3515 c-50 -19 -102 -68 -122 -115 -8 -19 -15 -64 -15 -100 -1
...
162 10 229 -1z"/><path d="M9317 3516 c-139 -50 -203 -168 -195 -365 3 -90 8 -115 32 -163 52
...
41 20 137 22 182 3z"/><path d="M10070 3519 c-60 -17 -120 -41 -120 -49 0 -4 7 -23 15 -43 l14 -35
...
-140 36 -30 33 -27 129 5 163 36 39 124 61 254 65 l47 1 0 -63z"/><path d="M10723 3516 c-94 -30 -138 -91 -131 -181 8 -93 30 -111 266 -216 40
...
-240 51 -321 26z"/><path d="M1755 2596 c-16 -7 -39 -23 -50 -36 -19 -21 -20 -38 -23 -528 -3
-539 -2 -545 46 -582 24 -19 43 -20 542 -20 499 0 518 1 542 20 48 37 49 43
46 582 -3 490 -4 507 -23 528 -44 49 -52 50 -567 50 -378 -1 -489 -4 -513 -14z"/><path d="M3153 2594 c-70 -35 -68 -17 -71 -539 -2 -259 0 -490 3 -514 5 -32
16 -54 40 -78 l33 -33 511 0 c422 0 517 2 539 14 58 30 57 24 57 575 0 474 -1
509 -18 535 -37 55 -43 56 -574 56 -424 0 -492 -3 -520 -16z"/><path d="M14536 2354 c-9 -8 -16 -31 -16 -49 0 -41 22 -65 59 -65 35 0 61 28
61 67 0 54 -67 85 -104 47z"/><path d="M6830 2347 c-232 -66 -346 -287 -299 -577 19 -121 80 -223 167 -278
...
10 21 15 42 12 47 -23 37 -275 63 -365 37z"/><path d="M11983 2333 c-19 -52 -345 -879 -349 -885 -3 -5 19 -8 50 -8 l54 0
...
c5 -16 38 -107 73 -202z"/><path d="M7502 2120 c-36 -8 -122 -40 -122 -45 0 -6 30 -75 33 -75 1 0 27 9
...
91 l89 1 -7 -62z"/><path d="M8265 2111 c-22 -10 -54 -33 -72 -51 l-31 -32 -7 46 -7 46 -44 0 -44
...
-24 -47 -39 -49 -33 -28 85 -200 131 -307 82z"/><path d="M9462 2118 c-18 -6 -52 -28 -76 -49 l-44 -39 -6 45 -7 45 -45 0 -44
...
4 141 -15z"/><path d="M10883 2114 c-52 -19 -110 -81 -119 -128 -18 -97 33 -163 167 -216
...
127 -7 206 -30 17 -5 23 1 36 34 16 39 16 39 -11 50 -89 34 -242 41 -318 15z"/><path d="M12762 2109 c-23 -12 -60 -42 -82 -68 l-40 -46 0 31 c0 17 -3 46 -6
...
-21z"/><path d="M13192 2120 c-53 -12 -122 -41 -122 -50 0 -8 19 -58 26 -68 2 -2 27
...
248 140 l82 1 0 -58z"/><path d="M13944 2106 c-28 -13 -60 -35 -71 -50 -27 -33 -33 -33 -33 3 0 50 -9
...
170 0 106 3 126 24 168 40 81 146 115 246 77z"/><path d="M15081 2119 c-36 -14 -95 -64 -111 -93 -21 -39 -29 -32 -32 32 l-3
...
0 -80 -5 -93 -10z"/><path d="M15492 2120 c-42 -10 -122 -40 -122 -46 0 -8 29 -74 32 -74 2 0 31
...
156 245 158 l82 1 0 -60z"/><path d="M16204 2114 c-57 -20 -120 -77 -149 -134 -48 -95 -57 -253 -19 -362
...
-12 33 -215 45 -292 18z"/><path d="M16815 2123 c-25 -5 -135 -44 -135 -48 0 -6 30 -75 33 -75 1 0 28 9
...
1 0 -38z"/><path d="M10020 1863 c0 -158 4 -274 11 -298 14 -50 72 -107 126 -123 106 -32
...
-136 61 -16 24 -18 59 -21 285 l-3 258 -50 0 -49 0 0 -257z"/><path d="M14530 1780 l0 -340 50 0 50 0 0 340 0 340 -50 0 -50 0 0 -340z"/></g></svg><p>Professor Paulo Cunha</p></header><main><h1>Retificador de meia onda controlado</h1><form id="form" class="form"><input type="number" name="fraction" id="fraction" placeholder="Fração da onda desejada:" min="2" max="10" value="2"><button id="change" type="submit">Alterar onda</button></form><span id="alert" class="alert">Mudança não enviada ao microcontrolador!</span><div class="waves"><div class="wave"><h2>Formato da onda de entrada</h2><canvas id="in-wave"></canvas></div><div class="wave"><h2>Formato da onda de saída</h2><canvas id="out-wave"></canvas></div></div></main><footer><p>Trabalho realizado por Ana Carleane, João Pedro, Luís Eduardo e Maria Letícia.</p></footer><script>const input = document.getElementById("fraction");
			...
			};</script><script>let amplitude = 100;
			let fraction = 2;
			...
			};</script><script>function wave(shape, periodStarted) {
			...
			createWave("out-wave", outWaveShape);</script></body></html>
)rawliteral";